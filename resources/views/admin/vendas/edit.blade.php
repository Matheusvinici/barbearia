...
@section('breadcrumb')
    ...
    <span>Vendas</span>
    <span class="sep">/</span>
    <span class="current">Editar Venda #{{ $venda->id }}</span>
@endsection

@section('subtitle')
    <span class="live-dot"></span>
    <span>Atualização da venda</span>
    <span class="pipe">·</span>
    <span>venda não vinculada a atendimento pode ser atualizada aqui</span>
@endsection
...
@include('admin.vendas._form', ['venda' => $venda])
