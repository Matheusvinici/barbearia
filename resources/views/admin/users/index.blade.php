...
<span>{{ $users->total() }} usuários cadastrados</span>
@endsection
...
@can('user.create')
<a href="{{ route('admin.users.create') }}" class="btn-primary-c"><svg class="icon icon-sm" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M6 12h12M12 6v12"/></svg>Novo Usuário</a>
@endcan
@endsection
    ...
    <div class="panel-header">
        <div class="panel-title-wrap">
            ...
            <div>
                ...
                <div class="panel-subtitle">Administradores e proprietários do sistema</div>
            </div>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="avatar-row">
                            <div class="av blue">{{ mb_substr($u->name, 0, 2) }}</div>
                            <div class="info">
                ...
                <tr>
                    <td colspan="4" style="text-align:center;padding:40px;color:var(--text-muted);">
                        <svg class="icon" style="width:40px;height:40px;margin-bottom:12px;opacity:0.3;" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 11v2h-8M18 9l4 4-4 4"/></svg>
                        <div style="font-size:15px;font-weight:600;margin-bottom:4px;">Nenhum usuário encontrado</div>
                        <div style="font-size:13px;">Clique em "Novo Usuário" para começar.</div>
                    </td>
                </tr>
                @endforelse
            </tbody>
