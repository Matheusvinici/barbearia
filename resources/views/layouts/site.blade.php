...
<head>
    ...
    <style>
        ...
        body { background: var(--bg); font-family: system-ui, -apple-system, sans-serif; min-height: 100vh; display: flex; flex-direction: column; }
        .site-header { background: var(--primary); color: #fff; padding: 1rem 0; text-align: center; }
        .site-header h1 { font-size: 1.5rem; margin: 0; font-weight: 700; }
        .site-header small { opacity: .8; }
        .main-content { flex: 1; padding: 1.5rem 0; }
        .step-card { background: #fff; border-radius: 16px; box-shadow: 0 2px 12px rgba(0,0,0,.08); padding: 1.5rem; margin-bottom: 1rem; }
        ...
        .footer { background: var(--primary); color: rgba(255,255,255,.7); padding: 1rem 0; text-align: center; font-size: .85rem; margin-top: auto; }
        ...
        @media (max-width: 576px) { .step-card { padding: 1rem; } }
    </style>
</head>
<body>
    <header class="site-header">
        <h1><i class="bi bi-scissors"></i> Barbearia</h1>
        <small>Agende seu horário online</small>
    </header>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="mt-1">&copy; {{ date('Y') }} Barbearia. Todos os direitos reservados.</div>
        </div>
    </footer>
