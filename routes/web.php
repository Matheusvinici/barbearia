...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::patch('/agendamentos/{agendamento}/inline-status', [AgendamentoController::class, 'inlineStatus'])->name('agendamentos.inline-status');
        Route::patch('/agendamentos/{agendamento}/inline-pagamento', [AgendamentoController::class, 'inlinePagamento'])->name('agendamentos.inline-pagamento');
